...
config = {'anchors': [10.0, 30.0, 60.], 'chanel': 1, 'crop_size': [128, 128, 128], 'stride': 4, 'max_stride': 16,
          'num_neg': 800, 'th_neg': 0.02, 'th_pos_train': 0.5, 'th_pos_val': 1, 'num_hard': 2, 'bound_size': 12,
          'reso': 1, 'sizelim': 6., 'sizelim2': 30, 'sizelim3': 40, 'aug_scale': True, 'r_rand_crop': 0.3,
          'pad_value': 170, 'augtype': {'flip': True, 'swap': False, 'scale': True, 'rotate': False},
