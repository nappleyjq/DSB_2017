...
config = {'anchors': [10.0, 25.0, 40.0], 'chanel': 2, 'crop_size': [64, 128, 128], 'stride': [2, 4, 4],
          'max_stride': 16, 'num_neg': 10, 'th_neg': 0.2, 'th_pos': 0.5, 'num_hard': 1, 'bound_size': 12,
          'reso': [1.5, 0.75, 0.75], 'sizelim': 6.,
          'blacklist': ['868b024d9fa388b7ddab12ec1c06af38', 'd92998a73d4654a442e6d6ba15bbb827',
