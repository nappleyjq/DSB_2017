...
config = {'anchors': [10.0, 30.0, 60.], 'chanel': 1, 'crop_size': [128, 128, 128], 'stride': 4,
          'datadir': config_training['preprocess_result_path'], 'max_stride': 16, 'num_neg': 800, 'th_neg': 0.02,
          'th_pos_train': 0.5, 'th_pos_val': 1, 'num_hard': 2, 'bound_size': 12, 'reso': 1, 'sizelim': 6.,
          'sizelim2': 30, 'sizelim3': 40, 'aug_scale': True, 'r_rand_crop': 0.3, 'pad_value': 170,
          ...
          'blacklist': ['868b024d9fa388b7ddab12ec1c06af38', '990fbe3f0a1b53878669967b9afd1441',
                        'adc3bbc63d40f8761c59be10f1e504c3'], 'lr_stage': np.array([50, 100, 140, 160]),
