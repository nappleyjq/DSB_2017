...
config = {'topk': 5, 'resample': None, 'datadir': '/run/shm/preprocess_1_3/', 'preload_train': True,
          'bboxpath': '../cpliangming/results/res18_prep3/bbox/', 'labelfile': '../stage1_labels.csv',
          'preload_val': True, 'padmask': False, 'crop_size': [96, 96, 96], 'scaleLim': [0.85, 1.15],
          'radiusLim': [6, 100], 'jitter_range': 0.15, 'isScale': True, 'random_sample': True, 'T': 1, 'stride': 4,
          ...
          'lr': [0.01, 0.001, 0.0001, 0.00001], 'miss_ratio': 1, 'miss_thresh': 0.03, 'anchors': [10, 30, 60]}
